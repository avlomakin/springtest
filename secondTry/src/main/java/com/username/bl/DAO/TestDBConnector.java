...
public class TestDBConnector extends AbstractDBConnector<TestEntity> {
    private static final String SELECT_ALL = "SELECT * FROM test_table";

    public TestDBConnector(String database, String user, String password) throws SQLException, ClassNotFoundException {
